...
public class Signup extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            ...
            if(username.equals("")||name.equals("")||password.equals("")||security.equals("")||answer.equals(""))
        {
...
//            this.setVisible(false);
            ...
            String query = "insert into acoount values('"+username+"','"+name+"','"+password+"','"+security+"','"+answer+"')";
            try{
                 Conn c= new Conn();
